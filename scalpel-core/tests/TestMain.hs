...
scrapeTests = "scrapeTests" ~: TestList
  ...
  , scrapeTest
    ...
    "<a>1</a><b>2</b><a>3</a>"
    (Just ("1", "2"))
    (inSerial $ (,) <$> stepNext (text "a") <*> stepNext (text "b"))
  , scrapeTest
  ...
  , scrapeTest
    ...
    "<a>1</a><b>2</b><a>3</a>"
    (Just ("2", "3"))
    (inSerial $ (,) <$> seekNext (text "b") <*> seekNext (text "a"))
  , scrapeTest
  ...
  , scrapeTest
    ...
    "<a>1</a><b>2</b><c>3</c>"
    (Just ("3", "1"))
    (inSerial $ (,) <$> seekNext (text "c") <*> seekBack (text "a"))
  , scrapeTest
    "Alternative sanity check for SerialScraper"
    "1<a foo=bar>2</a>3"
    (Just ["1", "bar", "3"])
    (inSerial $ many $ stepNext (text $ textSelector `atDepth` 0) <|> stepNext
      (attr "foo" $ "a" `atDepth` 0)
    )
  , scrapeTest
  ...
  , scrapeTest
    ...
    "1<a>2</a><b>3</b>"
    (Just ["1", "2"])
    (inSerial $ untilNext (matches "b") $ many $ stepNext $ text anySelector)
  , scrapeTest
    "untilNext should go till end of the zipper on no match"
    "1<a>2</a><b>3</b>"
    (Just ["1", "2", "3"])
    (inSerial $ untilNext (matches "c") $ many $ stepNext $ text anySelector)
  , scrapeTest
  ...
  , scrapeTest
    ...
    (Just ["1", "2"])
    (chroot "parent" $ inSerial $ many $ stepNext $ text anySelector)
  , scrapeTest
